...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/a47953a5ee354aff8b5ab.jpg"
else:
...
CUSTOM_MIDDLE_PMP = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**Hey welcome to my sweet master pm** \n This is KingBot Pm protection" 
...
USER_BOT_NO_WARN = ("`Hello, This Is An Antispam KINGUserbot Service⚠️.You have found your way here to my sweet master's ,`"
