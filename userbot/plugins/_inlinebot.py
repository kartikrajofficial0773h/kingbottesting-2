...
king_row = Config.BUTTONS_IN_HELP
king_emoji = Config.EMOJI_IN_HELP
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query == "@HellBot_Official":
            ...
            result = builder.article(
                "@KING_Bot_Official",
                text="""**Hey! This is [kingbot.](https://t.me/king_Bot_Official) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/king_Bot_Official"),
                        custom.Button.url(
                            "support", "https://t.me/king_Bot_OfficialChat"
                        ),
                    ],
                    [
                        custom.Button.url(
                            "✨ REPO ✨", "https://github.com/kartikrajofficial0773h/KINGBOT"),
                        custom.Button.url
                    (
    ...
    async def page(event):
        if not event.query.user_id == bot.uid:
            return await event.answer(
                "Heya!! kya touch kr rhe ho ye mere master ka h!! If chachiyw toh khud ka bna lo aaisa from @king_bot_official ™",
                cache_time=0,
                alert=True,
            )
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            await delete_hell(event,
              "🧞‍♂️KINGBOT MENU Closed🧞‍♂️\n\n         **[©KINGBOT ™](t.me/king_bot_official)**", 5, link_preview=False
            )
        else:
            hell_alert = "Heya!! kya touch kr rhe ho ye mere master ka h!! If chachiyw toh khud ka bna lo aaisa from @king_bot_official ™"
